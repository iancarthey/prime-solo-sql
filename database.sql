...
--records with an account balance of 0.00 and a transactions_attempted of 0. Give them a new account balance of 10.00.
...
VALUES ('Ian', 'Minneapolis', 10, 10, 1000000.00);
...
DELETE FROM "accounts" WHERE ("city" = 'miami' OR "city" = 'phoenix' OR "transactions_completed" < 5);
